...
<%!
	...
	ResultSet rs = null, rs2 =  null, row = null;
...
<%
		...
		String temPage = request.getParameter("cpage");
		...
		//String param = request.getParameter("sectordetail");
